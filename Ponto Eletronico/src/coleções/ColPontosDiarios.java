...
public class ColPontosDiarios {
	...
	//TODOS OS METODOS SET ALL ... � PARA O JASPERVIEW N�O BUGAR NO MOMENTO DE SETAR A VARI�VEL COM AS INFORMA��ES SOLICITADAS
	public void setAllNomes(String nome, String assinatura){
		//Adiciona em todos os pontos batidos pelo usuario o nome dele na vari�vel nome;
	...
	//ATUALIZA A COLE��O PASSANDO OS SABADOS, DOMINGOS E FALTAS DO USUARIO
	public ArrayList<PontoDiario> popularColecao(int mes, String ano){
		 ...
		 for (i=1; i<=QtdeDeDiasDaDataRecebida; i++) {
			//ATRIBUINDO O DIA AO CALENDARIO SALVO PARA VERFICAR SE � DIA DE SEMANA SE N�O FOR EU PREENCHO COM O DIA CORRESPONDENTE
	...
	//RETIRAR ESSA FUN��O DAQUI -- USADA EM VIEW ALTERA FOLHA
	...
	//CASO A VARIAVEL BOOLEANA SEJA TRUE SER� IMPRESSO O RESULTADO NO JTABLE
	//localJustificativa � uma variavel que receber� inteiros para poder atribuir corretamente onde ser� aplicada a justificativa.
	//Se 1, justificativa na entrada, se 2, justificativa na sa�da, se 3 justificativa na entrada e na sa�da
