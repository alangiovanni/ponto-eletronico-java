		...
		btnVariosRelatorios.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            if(resultado == JFileChooser.APPROVE_OPTION){
					...
					try {
						for (int i = 0; i < comboEstagiario.getItemCount(); i++){
							...
							if(localArmazenamento.exists()){
								//Se os pontos do usuario existirem, carrega na vari�vel
						...
						JOptionPane.showMessageDialog(null, "Relat�rios Criados com Sucesso!");
	                ...
	                JOptionPane.showMessageDialog(null, "Voc� n�o selecionou nenhum diretorio. Repita a opera��o!", "Nenhum diret�rio Selecionado", JOptionPane.ERROR_MESSAGE);
			}
		});
