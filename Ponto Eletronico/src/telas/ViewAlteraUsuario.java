			...
			public void actionPerformed(ActionEvent e) {
				...
				if(nome.equals("") || lotacao.equals("") || login.equals("") || (!rdbNao.isSelected() && !rdbSim.isSelected()))
					...
					if(rdbSim.isSelected()){
						...
						//Necess�rio converter para comparar se � uma STRING vazia
						if(String.valueOf(novaSenha).equals(""))
							JOptionPane.showMessageDialog(null, "ERRO: Por favor Defina uma NOVA SENHA para o ESTAGI�RIO.");
						else {
							...
							//Trecho necess�rio para poder setar as novas informa��es dentro da cole��o de pontos
							...
							JOptionPane.showMessageDialog(null, "NOVA SENHA definida e Informa��es de " + nome + " atualizadas com SUCESSO");
						...
						JOptionPane.showMessageDialog(null, "Informa��es de " + nome + " atualizadas com SUCESSO");
						//Limpar todos os campos e setar algumas funcionalidades
						limparCampos();
						btnSalvar.setEnabled(false);
						lblNovaSenha.setEnabled(false);
