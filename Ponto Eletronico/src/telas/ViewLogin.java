		...
		btnEntrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(administradores.autenticacao(login, senha)){
						...
						JOptionPane.showMessageDialog (null, "N�O ENCONTRAMOS ESTE USUARIO E SENHA EM NOSSO SISTEMA","ERRO DE AUTENTICA��O", JOptionPane.ERROR_MESSAGE);
						textLogin.setText("");
						textSenha.setText("");
					}
				}
