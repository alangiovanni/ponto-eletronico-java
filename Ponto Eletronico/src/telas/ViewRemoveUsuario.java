		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					JOptionPane.showMessageDialog(null, "Erro ao EXCLUIR diret�rio, tente excluir manualmente.\nInforma��es do Erro: " +erro, "ERRO AO EXCLUIR DIRETORIO", JOptionPane.ERROR_MESSAGE);
				}
